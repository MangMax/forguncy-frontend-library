...
- scripts/scaffold_package.mjs：生成包工作目录骨架（含 assets/package-template 模板）。
...
- assets/package-template/：包工作目录模板（package.json / build.mjs / src/entry.js / validate|smoke|pack.mjs / README）。
